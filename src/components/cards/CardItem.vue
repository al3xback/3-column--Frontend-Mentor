			...
			<svg width="64" height="40" xmlns="http://www.w3.org/2000/svg">
				<g fill="none" fill-rule="evenodd">
					...
					<path v-if="card.title === 'Sedans'"
						...
						:style="{ fill: shadeColor(cardBg, 60), transition: 'all 0.3s' }"
						fill-rule="nonzero"
					/>

					<path v-else-if="card.title === 'Suvs'"
						...
						:style="{ fill: shadeColor(cardBg, 75), transition: 'all 0.3s' }"
						fill-rule="nonzero"
					/>
					...
					<path v-else
						...
						:style="{ fill: shadeColor(cardBg, 180), transition: 'all 0.3s' }"
						fill-rule="nonzero"
					/>
				</g>
			</svg>
